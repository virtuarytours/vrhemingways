...
function eventKrpanoLoaded (isWebVr) {
	...
	ktools.I18N.getInstance().initLanguage(tourLanguage, crossDomainTargetUrl+'Hemingways Awesome Virtual Tourdata/Hemingways Awesome Virtual Tour_messages_','.xml');
	krpanoLoaded = true;
...
function eventTourChangeLanguage (pLang) {
	...
	ktools.I18N.getInstance().initLanguage(pLang, crossDomainTargetUrl+'Hemingways Awesome Virtual Tourdata/Hemingways Awesome Virtual Tour_messages_','.xml');
}
...
function addKolorMenu(pPlugID) 
{
	...
	{
		var kolorMenuCSS = new ktools.CssStyle("KolorMenuCSS", crossDomainTargetUrl+"Hemingways Awesome Virtual Tourdata/graphics/KolorMenu/kolorMenu.css");
		var kolorMenuJS = new ktools.Script("KolorMenuJS", crossDomainTargetUrl+"Hemingways Awesome Virtual Tourdata/graphics/KolorMenu/KolorMenu.min.js", [], true);
